...
public class ConverterNotFoundException extends Exception {
	...
	public ConverterNotFoundException(InputFormatEnum inputFormat, OutputFormatEnum outputFormat) {
		super(String.format("Could not find a converter between formats %s and %s.", inputFormat.getName(), outputFormat.getName()));
	}
}
