...
public class DescriptiveNotes {

    @XmlElement(name = "Descriptive_Note")
    protected List<DescriptiveNote> descriptiveNote;
     ...
     * This is why there is not a <CODE>set</CODE> method for the descriptiveNote property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDescriptiveNote().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DescriptiveNote> getDescriptiveNote() {
        if (descriptiveNote == null) {
            descriptiveNote = new ArrayList<DescriptiveNote>();
        }
